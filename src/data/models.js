...
export const MODELS = [
  ...
  // ===== OPENAI =====
  {
    ...
    speedTier: getSpeedTier(1800),
    pricing: { inputPerM: 2.5, outputPerM: 15.0 },
    context: { inputTokens: 1000000, outputTokens: 128000 },
    capabilities: {
      vision: true,
      audio: false,
  ...
  },
  {
    ...
    pricing: { inputPerM: 30.0, outputPerM: 180.0 },
    context: { inputTokens: 1050000, outputTokens: 128000 },
    capabilities: {
      vision: true,
      audio: false,
      extendedThinking: true,
  ...
  },
  {
    ...
    speedTier: getSpeedTier(9000),
    pricing: { inputPerM: 5.0, outputPerM: 30.0 },
