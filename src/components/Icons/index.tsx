...
// Helper to create consistent icon SVGs
const createIcon = (
  paths: React.ReactNode,
  viewBox = '0 0 24 24'
): React.FC<IconProps> => {
  return ({ size = 18, className, strokeWidth = 2 }) => (
    <svg
      width={size}
      height={size}
      viewBox={viewBox}
...
export const InsightsIcon = createIcon(
  <>
    ...
    <path d="m6 6 1.5 1.5M18 6l-1.5 1.5M6 18l1.5-1.5M18 18l-1.5-1.5" />
  </>
);
...
export const CompareIcon = createIcon(
  <>
    ...
    <path d="m21 3-7.828 7.828A4 4 0 0 0 12 13.657V22" />
  </>
);
...
// Araviel Brand Icon
export const AravielIcon = createIcon(
  <>
    <circle cx="12" cy="12" r="10" />
    <path d="M12 6v6l4 2" />
